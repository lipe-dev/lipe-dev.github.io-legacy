    ...
    >
      <a
        ...
        className={cn(
          ...
          cards && "bg-gray-200",
          cards &&
            "hover:shadow-diagonal transition duration-200 transform hover:scale-105",
          cards && "p-4 m-4",
          cards && "rounded-md"
        )}
      >
        <img
          className={cn(
            "mx-2 my-4 hover:shadow-diagonal hover:scale-105 rounded-full transform transition duration-200",
            cards && "w-20"
          )}
          alt="email-icon"
        ...
        />
        {cards && "Send an email to fe@lipe.dev"}
      </a>
      <a
      ...
      >
        ...
        />
        {cards && "Connect with me on LinkedIn"}
      </a>
    </div>
  );
}
